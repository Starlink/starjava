...
public class GlotsServiceFinder implements TapServiceFinder {
    ...
    public GlotsServiceFinder( String glotsUrl, ContentCoding coding ) {
        try {
            ...
            throw new RuntimeException( "Bad URL " + glotsUrl, e );
        }
        coding_ = coding;
     ...
     */
    private static String commaJoin( String[] words ) {
        StringBuffer sbuf = new StringBuffer();
     ...
     * @return  map
     */
    private Map<String,String> toValueMap( String[] keys, Object[] values ) {
        int n = keys.length;
