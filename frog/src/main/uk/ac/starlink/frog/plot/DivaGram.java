...
/**
 * Plots an atimes gram using a Swing component with Diva graphics
 * overlay support. <p>
 *
 * Series are defined as Gram objects encapulsulated in a GramComp
 * object. <p>
 *
 ...
 */
public class DivaGram extends JCanvas implements Printable, MouseListener
{
    /**
    ...
    /**
     * Reference to gram composite object. This plots the actual gram
     * and mediates requests about composite properties.
     */
    protected GramComp gram = null;
    ...
    /**
     * Object that contains a description of the non-gram AST properties
     ...
     * Plot a gram of gram.
     *
     * @param gram reference to gram.
     *
     * @exception FrogException thrown if problems reading gram.
     */
    public DivaGram( GramComp gram )
    ...
    /**
     * Plot a gram stored in a file.
     *
     * @param file name of file containing gram.
     *
     * @exception FrogException thrown if problems reading gram.
     */
    public DivaGram( String file ) throws FrogException
    {
        super();
        initConfig();
    ...
    /**
     * Initialise gram information.
     *
     * @param gram Description of the Parameter
     *
     * @exception FrogException thrown if problems reading gram.
     */
    protected void initSeries( GramComp gram )
        throws FrogException
    {
        ...
        //  Retain reference to gram data and properties.
        this.gram = gram;
        ...
        //  First time initialisation of gram properties.
        updateProps( true );
    ...
    /**
     * Get a reference to the GramComp that we're using.
     *
     * @return The specDataComp value
     */
    public GramComp getGramComp()
    {
        return gram;
    }

    /**
     * Change the GramComp that we should use.
     *
     * @param gram The new specDataComp value
     *
     * @exception FrogException thrown if problems reading gram.
     */
    public void setGramComp( GramComp gram ) throws FrogException
    {
        this.gram = gram;
        updateProps( true );
    }
    ...
    /**
     * Update the composite properties of the gram and setup for display.
     *
    ...
    public void updateProps( boolean init )
        throws FrogException
    {
        //  No gram, so maybe nothing to do.
        if ( gram.count() == 0 ) {
            return;
        }

        //  Get the gram AST frameset, that describes the
        ...
        //  Define the size of the box used to draw the gram
    ...
    {
        double[] range = gram.getAutoRange();
        xMin = range[0];
        xMax = range[1];
        yMin = range[2];
        yMax = range[3];
    ...
    /**
     * Fit gram to the displayed width. Follow this with a
    ...
    /**
     * Fit gram to the displayed height. Follow this with a setScale( x, 1
    ...
    /**
     * Update the plot to reflect any changes in the gram being plotted
     * (i.e. when a new gram is added).
     *
     * @exception FrogException thrown if problems reading gram.
     */
    public void update()
    ...
    /**
     * Draw the gram. This should use the current plotting attributes and
     * style.
     */
    protected void drawGram()
    {
        double[] limits = null;
        ...
        gram.drawGram( javaGrf, astJ.getPlot(), limits );
    }
    ...
    /**
     * Display the gram coordinate and interpolated value at the position
    ...
    {
        if ( gram.count() == 0 || ! showVHair ) {
            return;
        }
        String[] xypos =
            gram.formatInterpolatedLookup( (int) getVHairPosition(),
                                              astJ.getPlot() );
        tracker.updateCoords( xypos[0], xypos[1] );
    }

    /**
     * Transform a gram of positions between the graphics and current
    ...
    public void trackMouseMotion( final MouseMotionTracker tracker )
    {
        ...
        addMouseMotionListener(
            new MouseMotionListener()
            {
                ...
                {
                    if ( gram.count() == 0 || ! readyToTrack ) {
                        return;
                    }
                    String[] xypos = gram.formatLookup( e.getX(),
                                                           astJ.getPlot() );
                    tracker.updateCoords( xypos[0], xypos[1] );
    ...
    public double unFormat( int axis, String value )
    {
        ...
        return gram.unFormat( axis, astJ.getPlot(), value );
    }
    ...
    public String format( int axis, double value )
    {
        ...
        return gram.format( axis, astJ.getPlot(), value );
    }
    ...
    //  Make a postscript copy of the gram.
