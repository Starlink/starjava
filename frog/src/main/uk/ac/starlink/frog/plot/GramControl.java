...
/**
 * A GramControlobject consists of a Plot inside a scrolled pane and various
 ...
 * (0 upwards). <p>
 *
 * Finally this object can make the DivaGram produce a postscript and
 * JPEG output copy of itself. <p>
 *
 * See the DivaGram object for a description of the facilities it provides.
 *
 ...
 * @see Plot
 */
public class GramControl extends JPanel
               ...
               FigureListener, PlotScaledListener, ActionListener 
{
   /**
    ...
    /**
     * DivaGram object for displaying the series.
     */
    protected DivaGram plot;

    /**
     * GramComp object for retaining all series references.
     */
    protected GramComp series = new GramComp();
    ...
    /**
     * Panel for DivaGram. Use BorderLayout so that we can get a
    ...
    /**
     * Plot a list of series referenced in a GramComp object.
     *
     * @param series reference to GramComp object that is wrapping the
     *      series to display.
     * @exception FrogException thrown if problems reading series.
     */
    public GramControl( GramComp series ) throws FrogException
    {
        debugManager.print( 
           "            Creating GramControl( GramComp )..." );
        this.series = series;
        initUI(); 
     ...
     */
    public GramControl( String file ) throws FrogException
    {
        debugManager.print( 
           "            Creating GramControl( FileName )..." );
        //  Check series exists.
        GramFactory factory = GramFactory.getReference();
        Gram source = factory.get( file );
        if ( source == null ) {
            System.err.println( "Series '" + file + "' cannot be found" );
        }
        series = new GramComp( source );
        initUI(); 
    ...
    /**
     * Get the PlotConfiguration being used by the DivaGram.
     */
    ...
    protected void initUI() throws FrogException
    {
        ...
        //  Create a DivaGram object so that it can be called upon to
        //  do the drawing.
        plot = new DivaGram( series );
    ...
    /**
     * Return the DivaGram reference.
     *
     * @return reference to the DivaGram.
     */
    public DivaGram getPlot()
    {
        return plot;
    }
    ...
    /**
     * Change text in the 1st line of the GramControlstatus label
     *
    ...
    /**
     * Change text in the 2nd line of teh GramControl status label
     *
     * @param string the text
     */
    ...
    /**
     * Add a Gram reference to the list of displayed series.
     *
     * @param spec reference to a series.
     */
    public void addSeries( Gram spec )
    {
        series.add( spec );
        updatePlot();
    }
     ...
     * @param spec reference to a series.
     */
    public void removeSeries( Gram spec )
    {
        series.remove( spec );
        updatePlot();
    }
     ...
     * @return true if the Gram object is being displayed.
     */
    public boolean isDisplayed( Gram s )
    {
    ...
    /**
     * Return reference to GramComp.
     *
     * @return the GramComp object used to wrapp all series
    ...
    /**
     * Set the GramComp component used.
     *
     * @param series new GramComp object to use for wrapping any series
     *      displayed in the Plot.
     * @exception FrogException thrown if problems reading series data.
     */
    public void setGramComp( GramComp series )
        throws FrogException
    {
        this.series = series;
        plot.setGramComp( series );
    }
     ...
     * @return the current series.
     */
    public Gram getCurrentGram()
    {
        int currentIndex = series.getCurrentGram();
...
//
    ...
    public Frame getPlotCurrentFrame()
    {
        ...
        return (Frame) plot.getGramComp().getAst().getRef();
    }
