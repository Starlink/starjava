...
public class ArithmeticDialog extends JInternalFrame
{
    ...
    /**
     * TextEntryField for the floating point vlaue
     */   
     JTextField floatEntry = new JTextField();
        
    /**
     * Floating point value for arithmetic
     */
     double floating;
    ...
    protected void initUI( ) throws Exception
    {
       ...
       setLocation( ( frameSize.width - arithSize.width ) / 2 ,
                    ( frameSize.height - arithSize.height ) / 2  );
       ...
       // ----------------------
       JLabel floatLabel = new JLabel("<html>&nbsp;Value&nbsp;<html>");
       floatLabel.setBorder( BorderFactory.createEtchedBorder() );
       
       // entry widget       
       floatEntry.setColumns(14);

       // create the main panel
         
       mainPanel.add( seriesLabel );
       mainPanel.add( whichSeries );
       mainPanel.add( opsLabel );
       mainPanel.add( whichOps );       
       mainPanel.add( floatLabel );
       mainPanel.add( floatEntry );
     ...
     */
     protected boolean doArithmetic( )
     {
         ...
         String floatingString = floatEntry.getText();
         ...
         // convert primitive types
          try {
             floating = (new Double(floatingString)).doubleValue();
         } catch ( Exception e ) {
             debugManager.print( "      Invalid floating point number..." );
             dispose();      
         ...
         debugManager.print( "      Number    " + floatingString );
    ...
    protected void arithSeries() 
    {
        ...
        // grab the data
         ...
         memImpl = new MEMTimeSeriesImpl( 
                      seriesKey + " "+ opsKey +" " + floatEntry.getText() );
