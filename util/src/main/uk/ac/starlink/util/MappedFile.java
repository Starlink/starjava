 ...
 * classes.
 * This class implements the nom.tam.util ArrayDataInput, ArrayDataOutput
 * and RandomAccess interfaces
 * (<i>except it doesn't do ArrayDataOutput quite yet</i>)
 * in the same way that nom.tam.util.BufferedFile does.
 ...
 * <ul>
 * <li>Write access is not yet implemented
 ...
 * </ul>
 * None of these is insurmountable, and future releases should remove
 * these limitations.
 *
...
public class MappedFile 
    ...
    public MappedFile( String filename, String mode, int size )
            throws IOException {
        this( getNioBuffer( filename, mode, (long) size ) );
    }
    ...
    private static ByteBuffer getNioBuffer( String filename, 
                                            String mode, long size ) 
            throws IOException {
    ...
    private static ByteBuffer getExistingFileBuffer( String filename,
        ...
        return getNioBuffer( filename, mode, size );
    }
