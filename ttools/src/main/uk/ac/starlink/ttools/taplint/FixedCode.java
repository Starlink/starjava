...
public enum FixedCode implements ReportCode {
    ...
    E_EXVP( "Unknown semantics term in RDFa property attribute" ),
    ...
    E_PN0C( "Epn_core missing column" ),
    E_PN86( "Epn_core bad timestamp" ),
    E_PNDE( "Incorrect epn_core column type" ),
    ...
    E_PNMT( "Bad UCD in epn_core measurement_type" ),
    E_PNMX( "Epn_core min/max columns not paired" ),
    E_PNPL( "Illegal epn_core processing_level" ),
    E_PNST( "Service title not equal to schema" ),
    E_PNTG( "Illegal epn_core target_class" ),
    E_PNUL( "Illegal epn_core NULLs" ),
    E_PNUT( "Epn_core table wrong utype" ),
    E_PNMG( "Epn_core bad messenger" ),
    ...
    E_QAUT( "Access denied unexpectedly" ),
    E_QERR( "Query failed" ),
    ...
    W_EXVP( "Preliminary/deprecated semantics term in RDFa property att" ),
    W_FKUN( "Keys content" ),
    ...
    W_PNJD( "Implausible Julian Day" ),
    W_PNMT( "Questionable UCD in epn_core measurement_type" ),
    W_PNTS( "Non-standard timescale" ),
    W_PNUB( "Transitional EPN-TAP utype" ),
    W_QERR( "Query failed" ),
    ...
    W_SPUC( "Epn_core spatial UCD mismatch" ),
    W_SPUN( "Epn_core spatial unit mismatch" ),
    ...
    W_VCPD( "Preliminary/deprecated vocabulary term" ),
    ...
    I_PNIX( "Starting epn_core tests" ),
    I_PNSP( "Checking spatial-frame-specific coord metadata" ),
    I_PNNS( "Non-standard epn_core columns" ),
    I_POPA( "Job POSTed" ),
    ...
    S_PNCS( "EPN-TAP columns" ),
    S_PNCN( "Epn_core table count" ),
    S_QNUM( "Query count" ),
    S_QTIM( "Query time" ),
