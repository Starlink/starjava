...
/**
 * Writes Jython code which facilitates use of STILTS functionality
 * from Jython.
...
public class JyStilts {
    ...
    private String[] defCmd( String fname, String filterNickName )
        ...
        return new String[] {
            "def " + fname + "(table, *args):",
            "    '''" + formatter_.formatXML( filter.getDescription(), 4 ),
            "",
            "    Usage is: ",
            "        " + filter.getUsage(),
            "    '''",
            "    pfilt = " + getImportName( StepFactory.class )
                           + ".getInstance()"
                           + ".getFilterFactory()"
                           + ".createObject(\"" + filterNickName + "\")",
    ...
    private String[] defTask( String fname, String taskNickName )
        ...
        List lineList = new ArrayList( Arrays.asList( new String[] {
            "def " + fname + "(**kwargs):",
            "    '''" + task.getPurpose() + ".'''",
            "    task = " + getImportName( Stilts.class )
                          + "()"
                          + ".getTaskFactory()"
    ...
    /**
     * Writes jython source code for a <code>stilts.py</code> file
     * to standard output.
     * No arguments.
     */
