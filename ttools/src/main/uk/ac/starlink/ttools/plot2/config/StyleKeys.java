...
public class StyleKeys {
    ...
    private static ClippedShader[] createColorShaders( boolean isAllVisible ) {
        ...
        return new ClippedShader[] {
            ...
            clip( Shaders.LUT_COSMIC, 0, true ),
            clip( Shaders.LUT_EMBER, 0.05, true ),
            clip( Shaders.LUT_GOTHIC, 0.15, true ),
            clip( Shaders.LUT_RAINFOREST, 0.15, true ),
            clip( Shaders.LUT_VOLTAGE, 0.15, true ),
            ...
            clip( Shaders.LUT_GUPPY, 0, false ),
            clip( Shaders.LUT_ICEBURN, 0, false ),
            clip( Shaders.LUT_REDSHIFT, 0, false ),
            clip( Shaders.LUT_PRIDE, 0, false ),
            ...
            clip( Shaders.LUT_INFINITY, 0, false ),
