...
public class StarTableModel extends AbstractTableModel {
    ...
    public StarTableModel( StarTable startable ) {
        ...
        headMetas = new HashMap[ startable.getNumColumns() ];
        colClasses = new Class[ startable.getNumColumns() + extraCols ];
        colClasses[ 0 ] = Object.class;
        for ( int i = 0; i < startable.getNumColumns(); i++ ) {
            ...
            for ( Iterator it = head.metadata().entrySet().iterator();
                  it.hasNext(); ) {
    ...
    public int getColumnCount() {
        return startable.getNumColumns() + extraCols;
    }

    public int getRowCount() {
        return startable.getNumRows() + extraRows;
    }
    ...
    public Object getValueAt( int irow, int icol ) {
        ...
        if ( irow < extraRows ) {
            ...
            if ( icol == 0 ) {
                ...
                cell = startable.getCell( irow - extraRows, icol - extraCols );
            }
        }
        return cell;
    }
