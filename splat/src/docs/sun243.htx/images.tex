...
\makeatletter
\input{/loc/pwda/pdraper/java/cvs/java/source/splat/src/docs/sun243_htx/html.sty}
\input{/loc/pwda/pdraper/java/cvs/java/source/splat/src/docs/sun243_htx/star2html.sty} 
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmldisplayA{displaymath1606}%
\begin{displaymath}
 \displaystyle\sqrt{
    \displaystyle\frac{
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1800}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1802}%
\begin{displaymath}
 fwhm = w*2\sqrt{2}
 \end{displaymath}%
\lthtmldisplayZ
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1804}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1806}%
\begin{displaymath}
