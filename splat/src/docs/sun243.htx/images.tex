...
\providecommand{\stardoccategory}  {Starlink User Note}\providecommand{\stardocinitials}  {SUN}\providecommand{\stardocsource}    {sun243.5}\providecommand{\stardoccopyright}
{Copyright \copyright\ 2001-2005 Council for the Central Laboratory of the
Research Councils}
\providecommand{\stardocnumber}    {243.5}\providecommand{\stardocauthors}   {Peter W. Draper}\providecommand{\stardocdate}      {19 January 2005}\providecommand{\stardoctitle}     {SPLAT-VO -- A VO-enabled Spectral Analysis Tool}\providecommand{\stardocversion}   {3.0b}\providecommand{\stardocmanual}    {User's Manual}\providecommand{\stardocabstract}  {
...
\providecommand{\stardocname}{SUN/243.5}\markboth{SUN/243.5}{SUN/243.5}
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmldisplayA{displaymath1844}%
\begin{displaymath}
 \displaystyle\sqrt{
    \displaystyle\frac{
...
{\newpage\clearpage
\lthtmldisplayA{displaymath2085}%
\begin{displaymath}
