...
\makeatletter
\input{/loc/pwdc/pdraper/java/cvs/java/source/splat/src/docs/sun243_htx/html.sty}
\input{/loc/pwdc/pdraper/java/cvs/java/source/splat/src/docs/sun243_htx/star2html.sty} 
...
\providecommand{\stardoccategory}  {Starlink User Note}\providecommand{\stardocinitials}  {SUN}\providecommand{\stardocsource}    {sun243.2}\providecommand{\stardoccopyright}
{Copyright \copyright\ 2001-2003 Council for the Central Laboratory of the
Research Councils}
\providecommand{\stardocnumber}    {243.2}\providecommand{\stardocauthors}   {Peter W. Draper}\providecommand{\stardocdate}      {03 June 2003}\providecommand{\stardoctitle}     {SPLAT - A Spectral Analysis Tool}\providecommand{\stardocversion}   {2.0}\providecommand{\stardocmanual}    {User's Manual}\providecommand{\stardocabstract}  {
\textsf{SPLAT} is an extensible analysis and display tool for extracted
spectra.
}
\providecommand{\stardocname}{SUN/243.2}\markboth{SUN/243.2}{SUN/243.2}
...
\stepcounter{subsection}
{\newpage\clearpage
\lthtmldisplayA{displaymath1597}%
\begin{displaymath}
 \displaystyle\sqrt{
    \displaystyle\frac{
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1808}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1809}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1810}%
\begin{displaymath}
 fwhm = w*2\sqrt{2}
 \end{displaymath}%
\lthtmldisplayZ
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1811}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1812}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1813}%
\begin{displaymath}
...
{\newpage\clearpage
\lthtmldisplayA{displaymath1814}%
\begin{displaymath}
