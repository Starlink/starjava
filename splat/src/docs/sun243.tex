...
\begin{quote}
 ...
 \begin{itemize}
  ...
  \item \submenuitem{Options}{Match sideband}
  ...
  sidebands. By default they are aligned taking the sideband into account. 
  If you want to do otherwise deselect this item.
...
these the value will be set to \labelitem{Unknown}.
