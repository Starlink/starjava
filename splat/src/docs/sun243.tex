...
Copyright \copyright\ 2007 Science and Technology Facilities Council
}

% Variable part - replace [xxx] as appropriate.
\newcommand{\stardocnumber}    {243.27}
\newcommand{\stardocauthors}   {Peter W. Draper \& Mark Taylor}
\newcommand{\stardocdate}      {3 April 2007}
\newcommand{\stardoctitle}     {SPLAT-VO -- A VO-enabled Spectral Analysis Tool}
\newcommand{\stardocversion}   {3.8-0}
