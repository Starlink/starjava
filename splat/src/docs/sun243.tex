...
\newcommand{\stardocversion}   {3.10-0}
...
{\begin{center}
 \latexhtml{\includegraphics[scale=0.5]{sun243_figures/#1}}{\htmladdimg{#1.gif}}
 \end{center}
}

\newcommand{\clippedmainfigure}[1]
{\begin{center}
 \latexhtml{\includegraphics[scale=0.5,clip=true]{sun243_figures/#1}}{\htmladdimg{#1.gif}}
 \end{center}
}

% Inline a graphic (like an icon). Needs ".gif" and ".eps" forms.
\newcommand{\inline}[1]
        {\latexhtml{\includegraphics[scale=0.5]{sun243_figures/#1}}
