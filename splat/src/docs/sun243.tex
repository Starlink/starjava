...
\begin{itemize}
   ...
   \item The addition of facilities for viewing the spectral data
     directly (\ie\ in a table, rather than a plot), coupled with
     the ability to edit the values (individually or globally
     using algebraic expressions). Multi-level undo and redo
     are also provided.
   
   \item The addition of standard line identifier catalogues for the
     optical, IR and submillimetre wavebands. It is also possible to
     import external catalogues using a standard text format.

   \item The addition of full support for spectral coordinate systems. 
     ...
     two systems of rest frame \ie\ where the observations where
   ...
   \item The addition of various smoothing filters, average, median, Gauss,
