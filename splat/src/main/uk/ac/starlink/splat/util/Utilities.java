...
//
    ...
    /**
     * Set the location of a Frame or JFrame using the given default
     ...
     * symmetric method {@link saveLocation}.
     *
     * If the defaults value is null and no values exist already then
     * the frame is locate and sized using pack.
     */
    ...
    /**
     * Save the location of a Frame or JFrame to a package Preferences
     * object.
     *
     * The Preference names are "name_x", "name_y", "name_width"
     * and "name_height", where name is some symbolic String (like
     * mainWindow, plotWindow, etc.). These names are used when
     * restoring by the symmetric method {@link setLocation}.
     */
