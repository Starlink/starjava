 ...
 * refer to the main <code>SplatBrowser</code> object (which displays
 ...
 * the <code>SplatBrowser</code> documentation for the other commands
...
public class RemoteServer extends Thread
{
     ...
     */
    protected SplatBrowser browserMain = null;
     ...
     *  Create an instance.
     */
    public RemoteServer( SplatBrowser browserMain )
    {
        super( "Remote Beanshell command server" );
        initInterpreter();
        setSplatBrowser( browserMain );
        loadStaticPlugins();
    }
    ...
    protected void initInterpreter()
    {
        ...
        //  Import the "uk.ac.starlink.splat.iface.SplatBrowser" and
        //  "uk.ac.starlink.splat.iface.GlobalSpecPlotList"
        //  classes. Need this so we can trivially refer to the
        //  "browser" and "globallist" variables in scripts.
        try {
    ...
    {
        String plugins = System.getProperty( "splat.plugins", "" );
        if ( ! plugins.equals( "" ) ) {
    ...
    public void loadPlugin( String pluginFile )
    {
        ...
        try {
            ...
            e.printStackTrace();
            System.err.println( "Failed to load plugin in file:" + pluginFile);
        }
    }
    ...
    public void setSplatBrowser( SplatBrowser browserMain )
    {
        ...
        //  Establish the current SplatBrowser as the variable
        //  browser in the interpreter.
        try {
            interp.set( "browser", getSplatBrowser() );
        } 
        catch (Exception e) {
            //  Do nothing.
        }
    ...
    public void run()
    {
        ...
        while( true ) {
            ...
            if ( ! cookie.equals( inputLine ) ) {
                System.err.println( "Warning: remote access "+
