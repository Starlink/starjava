 ...
 * under the License.
 */
package uk.ac.starlink.splat.iface.laf;
...
public class WorkbenchScale {
    ...
    public static ImageIcon scaleIcon(ImageIcon icon) {
        int newWidth = (int) Math.round(icon.getIconWidth() * getScaleFactor());
        int newHeight = (int) Math.round(icon.getIconHeight() * getScaleFactor());
