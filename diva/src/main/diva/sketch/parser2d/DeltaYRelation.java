...
public class DeltaYRelation implements Relation {
     ...
     */
    public static String NAME = "deltaY";
     ...
     * elements (e1.y - e2.y).  The sites should be one of CENTER, NORTH_WEST,
     * NORTH, etc.
     */
    ...
    public double apply (SceneElement e1, SceneElement e2) {
        ...
        return RelationUtilities.siteY(r1, _site1) -
            RelationUtilities.siteY(r2, _site2);
    }
