/*
 * $Id: GraphViewEvent.java,v 1.2 2002/09/20 02:41:26 johnr Exp $
 *
...
public class GraphViewEvent extends java.util.EventObject {
    /**
     * The figure representing a node was moved. The target parameter
     * will be set to the moved figure.
     */
    public static final int NODE_MOVED   = 11;

    /**
     * The connector representing an edge was just routed. The target
     * parameter will be set to the rerouted edge.
     */
    public static final int EDGE_ROUTED   = 12;

    /**
     * The given node was just drawn, redrawn, or removed. The target
     * and oldValue parameters will be set to the drawn figure and null;
     * the redrawn figure and the redrawn figure; or null and the
     * removed figure respectively.
     */
    public static final int NODE_DRAWN         = 20;

    /**
     * The given edge was just drawn, redrawn, or removed. The target
     * and oldValue parameters will be set to the drawn figure and null;
     * the redrawn figure and the redrawn figure; or null and the
     * removed figure respectively.
     */
