/*
 * $Id: GraphEvent.java,v 1.2 2002/09/21 00:08:13 johnr Exp $
 *
...
public class GraphEvent extends java.util.EventObject {
    ...
    /**
     * An edge is added to a graph; target is the
     * edge, old value is the previous parent
     */
    public static final int EDGE_ADDED          = 20;

    /**
     * An edge is deleted from a graph; target is the
     * node, old value is the previous parent
     */
    public static final int EDGE_REMOVED        = 21;

    /**
     * A node is added to a graph; target is the
     * node, old value is the previous parent
     */
    public static final int NODE_ADDED          = 22;

    /**
     * A node is deleted from a graph; target is the
     * node, old value is the previous parent
     */
    public static final int NODE_REMOVED        = 23;
