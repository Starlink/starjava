...
public final class CanvasUtilities {
    ...
    private static double _west = Math.PI;
    private static double _north = -Math.PI/2;
    private static double _east = 0;
    private static double _south = Math.PI/2;
    private static double _northwest = -Math.PI*3/4;
    private static double _northeast = -Math.PI/4;
    private static double _southwest = Math.PI*3/4;
    private static double _southeast = Math.PI/4;
	...
	if(direction == SwingConstants.EAST) return _east;
	if(direction == SwingConstants.NORTH) return _north;
	if(direction == SwingConstants.WEST) return _west;
	if(direction == SwingConstants.SOUTH) return _south;
	if(direction == SwingConstants.NORTH_EAST) return _northeast;
	if(direction == SwingConstants.NORTH_WEST) return _northwest;
	if(direction == SwingConstants.SOUTH_EAST) return _southeast;
	if(direction == SwingConstants.SOUTH_WEST) return _southwest;
