/*
 * $Id: ManhattanConnector.java,v 1.13 2000/08/16 20:31:03 neuendor Exp $
 *
...
/** A Connector that draws itself with perpendicular lines. The connector
 ...
 * methods. To help it route itself, the connector contains an
...
public class ManhattanConnector extends AbstractConnector {
    ...
    public void setRouter (ManhattanRouter router) {
        this._router = router;
        getPaintedPath().shape =  _router.route(this);
    }
    ...
    public void translate (double x, double y) {
        repaint();
        Polyline2D line = (Polyline2D) getPaintedPath().shape;
        line.translate(x,y);
        repaint();
    }
}
