 ...
 *
 * $Id: FITSDataShort.java,v 1.4 2002/08/18 22:38:10 brighton Exp $
 */
...
// -------------------------------------------------------------------
// Note: The FITSData<type> classes can be generated from FITSDataShort
 ...
 */
public class FITSDataShort extends FITSData {

    // Memory mapped image data, or null if not defined
    private ShortBuffer _mappedBuffer;


    /** 
     * Constructor
     */
    public FITSDataShort(FITSImage fitsImage) {
        super(fitsImage);

	MappedByteBuffer byteBuffer = fitsImage.getByteBuffer();
	if (byteBuffer != null) {
	    _mappedBuffer = byteBuffer.asShortBuffer();
	}
    }
