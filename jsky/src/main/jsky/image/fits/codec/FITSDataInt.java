 ...
 *
 * $Id: FITSDataInt.java,v 1.4 2002/08/18 22:38:10 brighton Exp $
 */
...
// -------------------------------------------------------------------
// Note: The FITSData<type> classes can be generated from FITSDataInt
...
public class FITSDataInt extends FITSData {
	...
	if (byteBuffer != null) {
	    _mappedBuffer = byteBuffer.asIntBuffer();
	}
    }
