...
public class slasubs {
    ...
    */
    public static final double[] slaDcs2c(double a, double b) {
    ...
    **  P.T.Wallace   Starlink   31 October 1993
    */
    public static final double[] slaDmxv(double[][] dm, double[] va) {
        int i, j;
        double w;
    ...
    **  P.T.Wallace   Starlink   31 October 1993
    */
    public static final Point2D.Double slaDcc2s(double[] v) {
        double x, y, z, r;
    ...
    */
    /* angle in radians */
    public static final double slaDranrm(double angle) {
        double w;
    ...
    */
    ...
    public static final double[][] slaDeuler(String order, double phi, double theta, double psi) {
        int j, i, l, n, k;
