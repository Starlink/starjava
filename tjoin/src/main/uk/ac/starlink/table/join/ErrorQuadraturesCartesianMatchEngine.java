 ...
 * @since    1 Sep 2011
 */
public class ErrorQuadraturesCartesianMatchEngine extends AbstractCartesianMatchEngine {
     ...
     */
    public ErrorQuadraturesCartesianMatchEngine( int ndim, double scale ) {
        super( ndim );
        ndim_ = ndim;
    ...
    public String toString() {
        return ndim_ + "-d Cartesian with Quadratures Errors";
    }

    public Supplier<MatchKit> createMatchKitFactory() {
        final Supplier<CartesianBinner> binnerFact = createBinnerFactory();
        return () -> new ErrorQuadraturesCartesianMatchKit( binnerFact.get() );
    }
     ...
     */
    private static class ErrorQuadraturesCartesianMatchKit implements MatchKit {
         ...
         * @param  binner  binner
         */
        ErrorQuadraturesCartesianMatchKit( CartesianBinner binner ) {
            binner_ = binner;
        ...
        public double matchScore( Object[] tuple1, Object[] tuple2 ) {
            ...
            double err2 = getTupleError( tuple1 ) * getTupleError( tuple1 ) + getTupleError( tuple2 ) * getTupleError( tuple2 );
            //double err2 = err * err;
            double dist2 = 0;
            for ( int id = 0; id < ndim_; id++ ) {
