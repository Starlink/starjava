...
public class PlotWindow1 extends AuxWindow 
    ...
    public PlotWindow1( TopcatModel tcModel, Component parent ) {
        ...
        fromvisibleAction_ = new BasicAction( "New subset from visible",
            ...
            public void actionPerformed( ActionEvent evt ) {
                String name = tcModel_.enquireSubsetName( PlotWindow1.this );
                if ( name != null ) {
    ...
    private class ExportAction extends BasicAction {
        ...
        public void actionPerformed( ActionEvent evt ) {
            ...
            if ( chooser.showDialog( PlotWindow1.this, approve ) == 
                ...
                try {
                    ...
                    ErrorDialog.showError( PlotWindow1.this, "Write Error", e );
                }
                finally {
                    if ( ostrm != null ) {
                        try {
