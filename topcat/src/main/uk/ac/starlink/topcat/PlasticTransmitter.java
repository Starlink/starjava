 ...
 * which allow the user to send an action to either one or multiple
 ...
 * considerered.  If there are no such applications the actions
 * are disabled.
 *
 * @author   Mark Taylor
 * @since    12 Apr 2006
 */
public abstract class PlasticTransmitter implements ListDataListener {
    ...
    public PlasticTransmitter( HubManager hubman, URI messageId,
        ...
        broadcastAct_.putValue( Action.SMALL_ICON, ResourceIcon.BROADCAST );
     ...
     */
    protected abstract void transmit( ApplicationItem app ) throws IOException;
    ...
    private class TransmitAction extends AbstractAction {
        ...
        public void actionPerformed( ActionEvent evt ) {
            try {
                ...
                ErrorDialog.showError( evt.getSource() instanceof Component
